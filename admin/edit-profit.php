<?php include "header.php"; 
    if(isset($_GET['id'])){
        ...
        while($r = mysqli_fetch_assoc($fselect_query)){
            ...
            // $_SESSION['bce'] = $r['profit'];
            $_SESSION['pbce'] = $r['profit'];
        }
    }
    if(isset($_POST['balance_update'])){
        ...
        $new_id = $_SESSION['idd'];
        $reset_query = "UPDATE users_account SET profit='$new_balance' WHERE id='$new_id'";
...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 text-center">Edit Profit:</h1>
    ...
    <div class="formm mx-auto">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $_SESSION['pbce']; ?>" name="new_balance" placeholder="" class="form-control" >
            </div>
