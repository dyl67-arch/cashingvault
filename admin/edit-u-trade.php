<?php include "header.php";
    ...
    $sel_tra = "SELECT * FROM tbl_trades WHERE c_id = '$id' ";
    $query_sel_tra = mysqli_query($connected,$sel_tra);
    while($rot = mysqli_fetch_assoc($query_sel_tra)){
        // $stock = $rot['stock'];
        $asset = $rot['asset'];
        $prediction = $rot['prediction'];
        $amount = $rot['amount'];
        $payout = $rot['payout'];
        $t_id = $rot['t_id'];
        $status = $rot['status'];
...
<div class="container-fluid">
    <div class="row">
        <div class="fr w-80 mx-auto">
            <h5 class="mb-3 text-dark">Edit user trade</h5>
            <form action="process/transact" method="post">
										<div class="form-group ">
											<label>Select Asset</label>
											<select class="form-control"  name="assets" required>
												<option selected="" value="<?php echo $asset; ?>"><?php echo $asset; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="prediction">
                                <option value="<?php echo $prediction; ?>" selected><?php echo $prediction; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="<?php echo $amount; ?>" name="inv_amount" required>
                            <input type="hidden" class="form-control" value="<?php echo $t_id; ?>" name="t_id" required>
                            <input type="hidden" class="form-control" value="<?php echo $id; ?>" name="c_id" required>
                        </div>
                        <div class="form-group">
                            <label for="">Payout</label>
                            <input type="number" class="form-control" value="<?php echo $payout; ?>" name="payout" required> 
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?php echo $date; ?>" name="date" required> 
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn-primary" name="process_edit_trade" value="Process">
                        </div>
                    </form>
        </div>
    </div>
