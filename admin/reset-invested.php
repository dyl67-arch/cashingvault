<?php include "header.php"; 
    ...
    if(isset($_POST['balance_update'])){
        ...
        $new_id = $_SESSION['idd'];
        $reset_query = "UPDATE users_account SET invested='$new_balance' WHERE id='$new_id'";
        $reset_result = mysqli_query($connected,$reset_query);
        if($reset_result){
            $resetMsgSuc = "User account invested edit was successful";
        }else{
             $resetMsgErr = "Problem editting user account invested, contact web developer";
        }
    }
?>
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 text-center">Edit Invested:</h1>
