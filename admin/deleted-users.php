<?php include "header.php"; 
    $sql = "SELECT * FROM users_account WHERE deleted='1'";
                        ...
                        <?php while($row = mysqli_fetch_assoc($query)) : ?>
                            ...
                            <?php if($checkeddeleted == '1') : ?>
                                <tr>
                                    ...
                                    <td><a href="restore-user?id=<?php echo $row['id']?>" class="btn btn-sm btn-success">Restore Account</a></td>
                                </tr>
