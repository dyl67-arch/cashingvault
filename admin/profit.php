<?php   include "header.php"; 
    ...
    if(isset($_POST['submit'])){
        ...
        $updateUser = "UPDATE users_account SET profit='$balance' WHERE id='$uid'";
        $queryUpdateUser = mysqli_query($connected, $updateUser);
        if($queryUpdateUser){
            
                $msgSucc = "User's bonus was set Successfully";
            }
        else {
            $msgError = "Unable to set user's bonus";
        }
    }
?>
<!-- Begin Page Content -->
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Set Bonus:</h1>
    <h4 class="">You are setting Bonus for : <?php echo $firstname; ?></h4>
