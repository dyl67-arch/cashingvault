<?php include "header.php"; 
    ...
    if(isset($_POST['balance_update'])){
        ...
        $new_id = $_SESSION['idd'];
        $reset_query = "UPDATE users_account SET referral_bonus='$new_balance' WHERE id='$new_id'";
        $reset_result = mysqli_query($connected,$reset_query);
        if($reset_result){
            $resetMsgSuc = "User referral bonus edit was successful";
        }else{
             $resetMsgErr = "Problem editting user referral bonus, contact web developer";
        }
    }
?>
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 text-center">Edit referral bonus:</h1>
